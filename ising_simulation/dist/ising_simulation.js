...
function __wbg_adapter_35(arg0, arg1) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h8e14a8a9498816f6_multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ising_simulation_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
